...
if($pmdi_plugin->createSlug($themeName) == 'pro-isha' ){
	...
	'pmdi'           => array(
		array(
			'import_file_name'             => esc_html__( 'Import color magazine', 'pt-pmdi' ),
			'categories'                   => array( __('Category A','pt-pmdi') ),
	...
	'pmdi'           => array(
		array(
			...
			'import_customizer_file_url'	 => esc_url( 'https://www.postmagthemes.com/download/colornewsmagazine/customizer1.dat'),
      		'import_notice'                => __( 'You have activated Color NewsMagazine theme from postmagthemes hence its demo content will be set', 'pt-pmdi' ),
